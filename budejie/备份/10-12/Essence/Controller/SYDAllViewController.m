...
#import "SYDJokeCell.h"
#import "SYDVideoCell.h"
#import "SYDPictureCell.h"
#import "SYDVoiceCell.h"

static NSString *const SYDPictureCellId = @"SYDPictureCell";
static NSString *const SYDJokeCellId    = @"SYDJokeCell";
static NSString *const SYDVideoCellId   = @"SYDVideoCell";
static NSString *const SYDVoiceCellId   = @"SYDVoiceCell";
...
- (void)viewDidLoad {
    ...
    // 注册cell
    [self.tableView registerClass:[SYDVideoCell class] forCellReuseIdentifier:SYDVideoCellId];
    [self.tableView registerClass:[SYDVoiceCell class] forCellReuseIdentifier:SYDVoiceCellId];
    [self.tableView registerClass:[SYDPictureCell class] forCellReuseIdentifier:SYDPictureCellId];
    [self.tableView registerClass:[SYDJokeCell class] forCellReuseIdentifier:SYDJokeCellId];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SYDTopicCell *cell = nil;
    switch (topic.type) {
        case SYDTopicTypePicture:// 图片
            cell = [tableView dequeueReusableCellWithIdentifier:SYDPictureCellId];
            break;
        case SYDTopicTypeJoke:// 段子
            cell = [tableView dequeueReusableCellWithIdentifier:SYDJokeCellId];
            break;
        case SYDTopicTypeVoice:// 声音
            cell = [tableView dequeueReusableCellWithIdentifier:SYDVoiceCellId];
            break;
        case SYDTopicTypeVideo:// 视频
            cell = [tableView dequeueReusableCellWithIdentifier:SYDVideoCellId];
            break;
        default:
            break;
    }
